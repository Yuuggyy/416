  ...
  return (
    <div className="fixed bottom-0 inset-x-0 z-40 bg-card/95 backdrop-blur-md border-t border-border">
      ...
      <div className="max-w-7xl mx-auto px-3 py-2 flex items-center gap-3">
        ...
        {embed && (
          <a href={current.spotify_url!} target="_blank" rel="noreferrer" className="text-xs text-muted-foreground hover:text-primary inline-flex items-center gap-1" title="Ouvrir sur Spotify">
        ...
        <Button size="icon" variant="ghost" onClick={stop} aria-label="Fermer"><X className="h-4 w-4" /></Button>
      </div>
      {embed && playing && (
        <iframe
